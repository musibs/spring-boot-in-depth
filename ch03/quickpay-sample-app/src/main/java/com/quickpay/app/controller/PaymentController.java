...
// com.quickpay.observability.events.MetricEventPublisher;
...
public class PaymentController {
    ...
    public ResponseEntity<PaymentResponse> createPayment(@RequestBody PaymentRequest request) {
        ...
        logger.info("Processing payment request for amount: {} {}", request.amount(), request.currency());
        ...
        try {
            ...
            if (response.status().equals("SUCCESS")) {
                ...
                paymentMetrics.incrementPaymentCounter("sample-provider", request.currency());
                paymentMetrics.recordProcessingTime(processingDuration, "sample-provider", request.currency());*/
    ...
    public ResponseEntity<PaymentResponse> getPayment(@PathVariable String transactionId) {
        ...
        try {
            ...
            //metricEventPublisher.publishLatencyMetric("payment_lookup", latency, "sample-provider", true);
